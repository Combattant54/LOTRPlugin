...
import fr.combattant54.lotrapi.events.random_events.FindAllLootBoxEvent;
import fr.combattant54.lotrapi.events.random_events.LootBoxEvent;
...
public class LootBox extends ListenerWerewolf {
    ...
    public void onVillagerDeath(FinalDeathEvent event) {
        ...
        if (!event.getPlayerWW().getRole().isCamp(Camp.RING_COMMUNITY)) return;
